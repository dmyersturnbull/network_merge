...
Cytoscape can import MIF25 files. Just go to ```File → Import → Network → File```, and select the .mif25 file. You can use this to compare an input file with its StructNA‐generated output.
